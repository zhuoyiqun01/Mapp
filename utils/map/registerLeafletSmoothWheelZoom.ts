/**
 * Leaflet.SmoothWheelZoom — vendored registration for ESM (mutsuyuki).
 * @see https://github.com/mutsuyuki/Leaflet.SmoothWheelZoom/blob/master/SmoothWheelZoom.js
 */
// @ts-nocheck — Leaflet private APIs (_move, _limitZoom, …)
